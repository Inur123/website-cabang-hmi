...
@section('content')
    ...
    <div
        class="container mx-auto px-4 sm:px-6 py-12 sm:py-16 bg-gradient-to-br 0 dark:from-gray-900 dark:to-gray-800 rounded-2xl">
        <div class="flex flex-col md:flex-row justify-between items-center mb-8 sm:mb-12 gap-4" data-aos="fade-up">
            <div class="text-center md:text-left">
                ...
                <p class="text-sm sm:text-base text-gray-600 dark:text-gray-400">Artikel terpopuler pilihan editor</p>
            </div>
            <a href="/blog"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            @foreach ($popularPosts as $index => $popularPost)
                <article
                    class="group relative bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl overflow-hidden transform hover:-translate-y-2 transition-all duration-500"
                    data-aos="zoom-in" data-aos-delay="{{ $index * 100 }}">
                        ...
                        <div class="relative h-48 sm:h-56 overflow-hidden">
                            ...
                            @if ($index < 3)
                                <div class="absolute top-3 sm:top-4 left-3 sm:left-4">
                                    <span
                                        class="inline-flex items-center px-2 sm:px-3 py-1 rounded-full text-xs font-bold bg-gradient-to-r from-green-500 to-emerald-600 text-white shadow-lg">
                                        🔥 Popular
                                    </span>
                                </div>
                            @endif
                        ...
                        <div class="p-4 sm:p-6">
                            <div
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="font-medium truncate">{{ $popularPost->user->name }}</span>
                                </div>
                            ...
                            <p class="text-sm sm:text-base text-gray-600 dark:text-gray-300 line-clamp-3 mb-3 sm:mb-4">
                                {!! Str::limit(strip_tags($popularPost->content), 120) !!}
                            </p>
                            <div
        ...
        @if ($popularPosts->isEmpty())
            <div class="text-center py-12 sm:py-16" data-aos="fade-up">
                ...
                <p class="text-sm sm:text-base text-gray-600 dark:text-gray-400">Artikel populer akan ditampilkan di sini
                </p>
            </div>
        @endif
    </div>
